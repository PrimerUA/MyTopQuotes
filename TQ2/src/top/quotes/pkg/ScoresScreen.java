...
public class ScoresScreen extends Activity {
	...
	currentScore = getIntent().getIntExtra(ConstantsFacade.CURRENT_SCORE, 0);
	...
	TextView score = (TextView) view.findViewById(R.id.ScoreItem_resultText);
	LinearLayout contenLayout = (LinearLayout) view.findViewById(R.id.ScoreItem_contentLayout);
