...
public class ShowsProvider {
	...
	public static ArrayList<String> setQuotesList(Context context, int showId) {
		// if (originEnabled) {
		// return readFiles(context, listFiles.get(showId + 100));
		// } else {
		return readFiles(context, listFiles.get(showId));
		// }
	}
	...
	private static ArrayList<String> readFiles(Context context, Integer show) {
